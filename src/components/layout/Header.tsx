    ...
    <nav className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${
      ...
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between md:justify-center md:gap-12 lg:gap-20">
        ...
        <div className="hidden md:flex items-center gap-4">
          <a href="/login" className="text-sm font-bold text-white hover:text-emerald-400 transition-colors">
            Login
          </a>
          <a href="/register" className="text-sm font-bold bg-emerald-500 hover:bg-emerald-400 text-emerald-950 px-5 py-2 rounded-full transition-all shadow-[0_0_15px_rgba(16,185,129,0.3)] hover:shadow-[0_0_25px_rgba(16,185,129,0.5)]">
            Register
          </a>
        </div>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden absolute top-full left-0 w-full h-[100vh] bg-[#041706] z-50 p-6 border-t border-emerald-500/10 flex flex-col">
          ...
          <div className="mt-8 space-y-4">
            <a 
              href="/login" 
              className="block w-full text-center py-3 rounded-xl font-bold text-white bg-emerald-900/50 border border-emerald-500/30 hover:bg-emerald-800/60 transition-colors"
            >
              Login
            </a>
            <a 
              href="/register" 
              className="block w-full text-center py-3 rounded-xl font-bold text-emerald-950 bg-emerald-500 hover:bg-emerald-400 transition-colors"
            >
              Register
            </a>
          </div>
