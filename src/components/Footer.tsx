...
import { Bolt, Globe, Mail, MessageSquare } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 mb-6">
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-emerald-500 text-emerald-950 shadow-md">
            ...
            <div className="flex gap-3">
              <a href="#" className="w-9 h-9 bg-emerald-900/40 hover:bg-emerald-500 hover:text-[#041706] rounded-full flex items-center justify-center transition-colors duration-200">
                <Globe size={16} />
              </a>
