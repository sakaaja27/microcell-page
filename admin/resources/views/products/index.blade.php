        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
            <div class="p-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
                <div class="relative max-w-sm w-full">
                    ...
                    <input type="text" id="searchInput" placeholder="Cari produk..." class="w-full pl-10 pr-4 py-2 bg-white border border-slate-200 text-sm rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-all shadow-sm" onkeyup="searchTable()">
                </div>
            </div>
                    ...
                    <tbody class="divide-y divide-slate-100">
                        @foreach ($products as $product)
                            <tr class="hover:bg-slate-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4 font-medium text-slate-900 search-target">{{ $product->nama }}</td>
                                <td class="px-6 py-4 text-slate-600 truncate max-w-[250px] search-target">{{ $product->spesifikasi }}</td>
                                <td class="px-6 py-4 text-slate-600 truncate max-w-[250px] search-target">{{ $product->deskripsi }}</td>
                                <td class="px-6 py-4">
